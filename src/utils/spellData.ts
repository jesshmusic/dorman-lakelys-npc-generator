...
export function getSpellsForClass(classType: string, level: number): SpellSelection {
  ...
  if (spellsPerLevel[6] > 0)
    selection.level6 = selectSpells(spellList.level6 || [], spellsPerLevel[6]);
  if (spellsPerLevel[7] > 0)
    selection.level7 = selectSpells(spellList.level7 || [], spellsPerLevel[7]);
  if (spellsPerLevel[8] > 0)
    selection.level8 = selectSpells(spellList.level8 || [], spellsPerLevel[8]);
  if (spellsPerLevel[9] > 0)
    selection.level9 = selectSpells(spellList.level9 || [], spellsPerLevel[9]);
